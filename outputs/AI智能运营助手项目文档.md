...
本项目面向中小电商商家，构建一套以商品评论数据为核心的智能运营辅助系统。系统通过评论数据导入、清洗、情感分析、关键词提取、差评原因分类、人工标签修正和大模型生成能力，帮助商家快速识别消费者痛点、总结商品优缺点、生成运营建议、营销文案和差评回复模板。
